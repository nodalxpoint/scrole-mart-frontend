// src/app/admin/cancelled/cancelled-order-detail/cancelled-order-detail.component.ts
...
@Component({
  selector:    'app-cancelled-order-detail',
  standalone:  true,
  imports:     [CommonModule, FormsModule],
  templateUrl: './cancelled-order-detail.component.html',
  styleUrl:    './cancelled-order-detail.component.css',
})
export class CancelledOrderDetailComponent implements OnInit {
  ...
  goBack(): void {
    this.router.navigate(['/admin/cancelled']);
  }

  private buildTimeline(status: string): TimelineStep[] {
    // Cancelled orders: placed → cancelled
    return [
