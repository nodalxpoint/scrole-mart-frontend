// src/app/admin/delivered/delivered-order-detail/delivered-order-detail.component.ts
...
@Component({
  selector:    'app-delivered-order-detail',
  standalone:  true,
  imports:     [CommonModule, FormsModule],
  templateUrl: './delivered-order-detail.component.html',
  styleUrl:    './delivered-order-detail.component.css',
})
export class DeliveredOrderDetailComponent implements OnInit {
